...
### Dados (gala)
data(gala) # Função data() importa o banco de dados gala do pacote faraway
help(gala) # Mostra a descrição dos dados no help
gala <- gala |> 
  as_tibble() # Transforma em tibble
gala # Diversidade de espécies nas ilhas Galápagos
...
#### Vemos, no quadro anterior, alguns sinais de multicolinearidade: nenhum preditor é significativo, mas R2 é relativamente alto.
